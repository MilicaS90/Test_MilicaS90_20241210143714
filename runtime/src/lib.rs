...
impl pallet_multisig::Config for Runtime {
   ...
   type Currency = Balances;
   type DepositBase = ConstU128<{ 1 * 1000 }>;
   type DepositFactor = ConstU128<{ 1 * 1000 }>;
   type RuntimeEvent = RuntimeEvent;
}
...
impl pallet_identity::Config for Runtime {
   ...
   type Currency = Balances;
   type SubAccountDeposit = ConstU128<{ 100 * 1000 }>;
   type Slashed = ();
   type RuntimeEvent = RuntimeEvent;
   type PendingUsernameExpiration = ConstU32<{ 7 * DAYS }>;
   type BasicDeposit = ConstU128<{ 1 * 1000 }>;
   type MaxUsernameLength = ConstU32<32>;
   type IdentityInformation = IdentityInfo<ConstU32<100>>;
   type WeightInfo = pallet_identity::weights::SubstrateWeight<Runtime>;
   type ByteDeposit = ConstU128<{ 1 * 1000 }>;
